...
package framework.slide.managers.group.presets
{
    ...
    public class VerticalGroup extends Group
    {
        ...
        public function VerticalGroup(interval:Number, horizontalAlign:String = "center", verticalAlign:String = "center")
        {
        ...
        {
            var ret:VerticalGroup = new VerticalGroup(interval, horizontalAlign, verticalAlign);
            return ret;
        }
