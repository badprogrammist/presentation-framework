...
package framework.entity.group.presets
{
    ...
    {
        public function HorizontalGroup(id:String, interval:Number, horizontalAlign:String = "center", verticalAlign:String = "center")
        {
        ...
        {
            var ret:HorizontalGroup = new HorizontalGroup(id, interval, horizontalAlign, verticalAlign);
            return ret;
        }
